...
#We worked on this challenge for a long time and ran into several issues while doing so. As a result, we refactored on the go as we were writing code. we both felt that this was a better approach to take. 
